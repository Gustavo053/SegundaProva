...
import com.example.segundaprova.adapters.EmpresaAdapter
...
class HomeFragment : Fragment() {
    ...
    var empresaAdpater = EmpresaAdapter()
    ...
    override fun onCreateView(
        ...
        viewModel.lista?.observe(viewLifecycleOwner, {
            empresaAdpater.empresas = it
            empresaAdpater.notifyDataSetChanged()
        })
        ...
        binding.recyclerView.addOnItemTouchListener(
            ...
            object : MyRecyclerViewClickListener.OnItemClickListener{
                override fun onItemClick(view: View, position: Int) {
                    Navigation.findNavController(view).navigate(HomeFragmentDirections.actionHomeFragmentToDetalhesFragment(empresaAdpater.empresas[position].id.toLong()));
                }

                override fun onItemLongClick(view: View, position: Int) {
                    Navigation.findNavController(view).navigate(HomeFragmentDirections.actionHomeFragmentToAlteraFragment(empresaAdpater.empresas[position].id.toLong()));
                }
            })
        )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerView.adapter = empresaAdpater
